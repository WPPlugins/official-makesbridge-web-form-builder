=== Web Form Builder by Makesbridge ===
...
Easy drag and drop to build any kind of form.The official Makesbridge drag and drop form builder plugin.
...
* Feedback form is integrated.
* Improve styles of the plugin.
...
= 1.1 =
Updated plugin with latest WordPress version.Remove bugs and improve the styling of the plugin.
